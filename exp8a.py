...
Original file is located at
    https://colab.research.google.com/drive/1KIGIGSM3D8qiSu-cmwCbmMD7drJMHhDe
"""
...
master = Tk()
master.title("Aimaan KHAN Customer Segmentation using Machine Learning")
Label(master, text="Aimaan Khan Customer Segmentation using Machine Learning", bg="Yellow", fg="black").grid(row=0, columnspan=2)
...
def show_entry_fields():
   ...
   Label(master, text=cluster_info[result[0]]).grid(row=4)
master = Tk()
master.title("Student Placement Segmentation by Aimaan")
