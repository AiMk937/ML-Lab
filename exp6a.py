...
Original file is located at
    https://colab.research.google.com/drive/1NMZFZPN_HF_unjSrgf6kZT7qJoPOfDwR
"""
...
window = tk.Tk()
window.title("Random Forest Classifier GUI AiM 211P039")
...
# Set up the GUI window
window = tk.Tk()
window.title("Bagging Classifier GUI AiMaan")
...
def create_gui():
  ...
  window = tk.Tk()
  window.title("Bagging Regressor GUI with Grid Search by Aimaan")
